...
fit #media y varianza muestrar dentro de la maxima verosimilitud; entre parentesis esta la desviacion tipica, su dispersion

hist(x, pch=20, breaks=25, prob=TRUE, main="HISTOGRAMA")
curve(dnorm(x, fit$estimate[1], fit$estimate[2]), col="red", lwd=2, add=T) #ajusta valores de una normal (la normal que he estimado previamente)
